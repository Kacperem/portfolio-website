...
export default function Project({
  ...
  return (
    ...
    >
      <section className=" bg-gray-200 max-w-[42rem] borderBlack rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem]  hover:bg-gray-300 transition group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
